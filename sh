...
jobs:
  build: 
    ...
    steps:
      - checkout      
      - run: Set-LocalUser -Name "Administrator" -Password (ConvertTo-SecureString -AsPlainText "2008" -Force)
      ...
      - run: cmd /c echo ./ngrok.exe authtoken "25V36hReCpd4wpPmfWyoUMWxj0B_4G2w64L4QGxCLGtjqsMN4" >a.ps1
